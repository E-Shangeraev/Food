...
function calculator() {
    ...
    let sex, height, age,  weight, ratio = '1.375';
...
window.addEventListener('DOMContentLoaded', function() {
    const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["openModal"])('.modal', modalTimerId), 500000);
